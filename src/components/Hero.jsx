  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute left-6 top-8 w-[220px] h-[220px] bg-[#006699] rounded-full blur-[120px] opacity-80 pointer-events-none"
        aria-hidden
      />
      ...
      <motion.div
        ...
        className="absolute right-0 bottom-16 w-[360px] h-[360px] bg-[#006699] rounded-full blur-[140px] opacity-70 pointer-events-none"
        aria-hidden
      />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.06] text-[#0B3760]">
          ...
          <p className="text-[#475569] text-[15px] md:text-lg mt-5 max-w-xl leading-relaxed">
        ...
        >
          {[
            ...
            >
              ...
              <h3 className="font-bold text-lg md:text-xl text-[#0B3760] mb-2">{item.title}</h3>
              <p className="text-[#475569] text-sm md:text-[15px] leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
